...
<div class="container pb-5">
    ...
    <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="shop_logo"
                                class="form-control @error('shop_logo') is-invalid @enderror" accept=".png">
                            @error('shop_logo')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="shop_domain" value="{{ $settings['shop_domain'] ?? '' }}"
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                ...
                                <select name="shop_language" class="form-select">
                                    <option value="pl"
                                        {{ ($settings['shop_language'] ?? 'pl') == 'pl' ? 'selected' : '' }}>Polski
                                    </option>
                                    <option value="en"
                                        {{ ($settings['shop_language'] ?? 'pl') == 'en' ? 'selected' : '' }}>English
                                    </option>
                                </select>
                            </div>
                            <div class="col-6">
                                ...
                                <select name="shop_currency" class="form-select">
                                    <option value="PLN"
                                        {{ ($settings['shop_currency'] ?? 'PLN') == 'PLN' ? 'selected' : '' }}>PLN
                                    </option>
                                    <option value="EUR"
                                        {{ ($settings['shop_currency'] ?? 'PLN') == 'EUR' ? 'selected' : '' }}>EUR
                                    </option>
                                    <option value="USD"
                                        {{ ($settings['shop_currency'] ?? 'PLN') == 'USD' ? 'selected' : '' }}>USD
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary shadow-sm"
                                data-bs-toggle="modal" data-bs-target="#addShippingMethod">
                                + Dodaj metodę
                            </button>
                        </div>
                        ...
                        <div class="mb-3 p-2 border rounded bg-light">
                            ...
                            <input type="number" step="0.01" name="shipping[{{ $method->id }}]"
                                value="{{ $method->price }}" class="form-control">
                        </div>
                        @endforeach
                    </div>
                </div>
                <div class="card shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="vat_rate" value="{{ $settings['vat_rate'] ?? 23 }}"
                                class="form-control">
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 text-center mt-2">
            <button type="submit" class="btn btn-primary btn-lg px-5 shadow rounded-pill">Zapisz wszystkie
                ustawienia</button>
        </div>
    </form>
</div>
