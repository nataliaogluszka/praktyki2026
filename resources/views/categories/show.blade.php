...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- <a href="/categories" class="text-primary text-decoration-none fw-bold">Zobacz wszystkie kategorie &nbsp;
            &uarr;</a> -->
    </div>
        ...
        <div class="col">
            <div class="card h-100 border-0 shadow-sm hover-shadow transition">
                ...
                <div class="card-body d-flex flex-column">
                    <h5 class="card-title fw-bold text-dark"><a href="{{ route('products.show', $product->id) }}" style="text-decoration: none; color: inherit;">{{ $product->name }}</a></h5>
