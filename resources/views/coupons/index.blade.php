                    ...
                    <form id="couponForm" action="{{ route('coupons.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label small fw-bold text-secondary text-uppercase"
                                style="font-size: 0.7rem;">Kod (np. LATO2024)</label>
                            <input type="text" name="code" id="couponCode" class="form-control border-light bg-light"
                                required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label small fw-bold text-secondary text-uppercase"
                                style="font-size: 0.7rem;">Typ rabatu</label>
                        ...
                        <div class="mb-4">
                            <label class="form-label small fw-bold text-secondary text-uppercase"
                                style="font-size: 0.7rem;">Wartość</label>
                            <input type="number" step="0.01" name="value" id="couponValue"
                                class="form-control border-light bg-light" placeholder="0.00" required>
                        </div>
